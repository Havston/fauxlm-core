"""
Конфигурация FauxLM Core.

Это открытая (MIT) часть FauxLM — только моковые эндпоинты. Никаких
профилей, хаос-сценариев или лицензий здесь нет: это всё часть FauxLM
...
# app/state.py (общий файл с FauxLM Pro, копируется без изменений при
