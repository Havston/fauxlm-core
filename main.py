...
logger = logging.getLogger("aircode")

app = FastAPI(title="AirCode Core", description="Открытый локальный мок-сервер для LLM API")
...
<body>
  ...
  часть AirCode Pro. Подробности: <a href="https://github.com/">страница проекта</a>.</p>
